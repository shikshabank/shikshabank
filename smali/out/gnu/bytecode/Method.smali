...
.method public setSignature(Ljava/lang/String;)V
    ...
    .line 284
    .local v3, "types":Ljava/util/Stack;, "Ljava/util/Stack<Lgnu/bytecode/Type;>;"
    :goto_18
    invoke-static {p1, v2}, Lgnu/bytecode/Type;->signatureLength(Ljava/lang/String;I)I

    move-result v4

    .line 285
    .local v4, "arg_sig_len":I
    if-gez v4, :cond_57
    ...
    .line 297
    iget-object v4, p0, Lgnu/bytecode/Method;->arg_types:[Lgnu/bytecode/Type;
    ...
    invoke-static {p1, v1, v4}, Lgnu/bytecode/Type;->signatureToType(Ljava/lang/String;II)Lgnu/bytecode/Type;

    move-result-object v1

    iput-object v1, p0, Lgnu/bytecode/Method;->return_type:Lgnu/bytecode/Type;

    .line 299
    return-void

    .line 289
    .restart local v4    # "arg_sig_len":I
    :cond_51
    new-instance v5, Ljava/lang/ClassFormatError;

    invoke-direct {v5, v1}, Ljava/lang/ClassFormatError;-><init>(Ljava/lang/String;)V

    throw v5

    .line 291
    :cond_57
    invoke-static {p1, v2, v4}, Lgnu/bytecode/Type;->signatureToType(Ljava/lang/String;II)Lgnu/bytecode/Type;

    move-result-object v5

    .line 292
    .local v5, "arg_type":Lgnu/bytecode/Type;
    ...
    .line 294
    .end local v4    # "arg_sig_len":I
    .end local v5    # "arg_type":Lgnu/bytecode/Type;
    goto :goto_18

    .line 275
    .end local v2    # "pos":I
    .end local v3    # "types":Ljava/util/Stack;, "Ljava/util/Stack<Lgnu/bytecode/Type;>;"
    :cond_60
    new-instance v2, Ljava/lang/ClassFormatError;

    invoke-direct {v2, v1}, Ljava/lang/ClassFormatError;-><init>(Ljava/lang/String;)V
