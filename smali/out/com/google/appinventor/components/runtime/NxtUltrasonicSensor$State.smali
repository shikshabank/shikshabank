...
.method static constructor <clinit>()V
    ...
    new-instance v1, Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;

    const-string v3, "BELOW_RANGE"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;->BELOW_RANGE:Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;

    new-instance v3, Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;

    const-string v5, "WITHIN_RANGE"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;->WITHIN_RANGE:Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;

    new-instance v5, Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;

    const-string v7, "ABOVE_RANGE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;->ABOVE_RANGE:Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;
    ...
    sput-object v7, Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;->$VALUES:[Lcom/google/appinventor/components/runtime/NxtUltrasonicSensor$State;
