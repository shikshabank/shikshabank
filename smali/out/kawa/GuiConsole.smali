...
.method private setupMenus()V
    ...
    .line 96
    .local v0, "windowExitCmd":Ljava/awt/event/WindowListener;
    ...
    .line 107
    new-instance v5, Ljava/awt/MenuItem;

    sget-object v6, Lkawa/GuiConsole;->NEW_SHARED:Ljava/lang/String;

    invoke-direct {v5, v6}, Ljava/awt/MenuItem;-><init>(Ljava/lang/String;)V
    ...
    sget-object v6, Lkawa/GuiConsole;->CLOSE:Ljava/lang/String;
    ...
    sget-object v6, Lkawa/GuiConsole;->EXIT:Ljava/lang/String;
    ...
    sget-object v6, Lkawa/GuiConsole;->PURGE_MESSAGE:Ljava/lang/String;
    ...
    .line 122
    invoke-virtual {v3, v4}, Ljava/awt/Menu;->add(Ljava/awt/MenuItem;)Ljava/awt/MenuItem;
...
.method public actionPerformed(Ljava/awt/event/ActionEvent;)V
    ...
    iget-object v3, v3, Lkawa/ReplDocument;->language:Lgnu/expr/Language;

    invoke-static {}, Lgnu/mapping/Environment;->getGlobal()Lgnu/mapping/Environment;

    move-result-object v4

    invoke-direct {v1, v3, v4, v2}, Lkawa/GuiConsole;-><init>(Lgnu/expr/Language;Lgnu/mapping/Environment;Z)V
...
.method init(Lkawa/ReplDocument;)V
    ...
    invoke-virtual {p0, v2, v0}, Lkawa/GuiConsole;->add(Ljava/lang/String;Ljava/awt/Component;)Ljava/awt/Component;
    ...
    invoke-virtual {p0, v2, v0}, Lkawa/GuiConsole;->setLocation(II)V
    ...
    invoke-virtual {p0, v0, v2}, Lkawa/GuiConsole;->setSize(II)V

    .line 59
    invoke-virtual {p0, v1}, Lkawa/GuiConsole;->setVisible(Z)V
